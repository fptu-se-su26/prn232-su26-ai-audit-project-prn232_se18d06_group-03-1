...
public interface IAdminUserService
{
    ...
    Task<AuthUserResponse> CreateCustomerAsync(AdminCreateCustomerRequest request, CancellationToken cancellationToken = default);
    Task<AuthUserResponse> CreateOwnerAsync(AdminCreateOwnerRequest request, CancellationToken cancellationToken = default);
    Task<AdminOwnerOcrPreviewResponse> PreviewOwnerDocumentsAsync(AdminOwnerOcrPreviewRequest request, CancellationToken cancellationToken = default);
