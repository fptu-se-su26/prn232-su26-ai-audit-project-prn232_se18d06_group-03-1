...
public interface INationalIdVerificationLogService
{
    Task LogAsync(NationalIdVerificationLogEntry entry, CancellationToken cancellationToken = default);
}

public class NationalIdVerificationLogEntry
{
