...
namespace MoveVN.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915120000_AddDriverLicenseLastSubmittedAt")]
    partial class AddDriverLicenseLastSubmittedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<decimal>("CancellationForfeitedAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("cancellation_forfeited_amount");

                    b.Property<decimal>("CancellationOwnerCompensation")
                        .HasColumnType("numeric")
                        .HasColumnName("cancellation_owner_compensation");

                    b.Property<decimal>("CancellationPlatformFee")
                        .HasColumnType("numeric")
                        .HasColumnName("cancellation_platform_fee");

                    b.Property<string>("CancellationPolicyTier")
                        .HasColumnType("text")
                        .HasColumnName("cancellation_policy_tier");
                    ...
                    b.Property<DateTime?>("EscrowHeldAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("escrow_held_at");

                    b.Property<DateTime?>("EscrowSettledAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("escrow_settled_at");
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.CmsPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.EmailLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.FavoriteVehicle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.Promotion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal?>("OwnerBearsPercent")
                        .HasColumnType("numeric")
                        .HasColumnName("owner_bears_percent");
                    ...
                    b.Property<string>("WhoBears")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("who_bears");
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.PromotionUsage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal>("OwnerPaidAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("owner_paid_amount");

                    b.Property<long>("PromotionId")
                        .HasColumnType("bigint")
                        .HasColumnName("promotion_id");

                    b.Property<decimal>("SystemPaidAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("system_paid_amount");
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("SecurityPinHash")
                        .HasColumnType("text")
                        .HasColumnName("security_pin_hash");
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<bool>("SecurityRequiresDeposit")
                        .HasColumnType("boolean")
                        .HasColumnName("security_requires_deposit");
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.VoucherClaim", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CustomerId", "PromotionId")
                        .IsUnique();

                    b.ToTable("voucher_claims", (string)null);
                });
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.HasOne("MoveVN.Domain.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("MoveVN.Domain.Entities.VehicleFeatureMapping", b =>
                {
                    b.HasOne("MoveVN.Domain.Entities.VehicleFeature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoveVN.Domain.Entities.Vehicle", "Vehicle")
