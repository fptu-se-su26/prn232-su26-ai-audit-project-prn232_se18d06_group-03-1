...
public class VehiclesController : ControllerBase
{
    ...
    [HttpGet("my")]
    public async Task<ActionResult<PagedResult<VehicleListItemResponse>>> GetMyVehicles(
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<VehicleResponse>> GetById(long id, CancellationToken cancellationToken = default)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<VehicleResponse>> Create([FromBody] CreateVehicleRequest request, CancellationToken cancellationToken = default)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<VehicleResponse>> Update(long id, [FromBody] UpdateVehicleRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult> ToggleStatus(long id, CancellationToken cancellationToken = default)
    {
