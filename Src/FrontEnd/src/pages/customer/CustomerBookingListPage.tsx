  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6">
      <DashboardHeader
        ...
        description="Theo dõi toàn bộ chuyến đi, trạng thái thanh toán và tiến độ nhận trả xe của bạn."
        actions={<StatusBadge>{`${totalCount} booking`}</StatusBadge>}
      />
      ...
      <SectionPanel
        ...
        description="Mở chi tiết để xem lịch trình, thanh toán, chính sách hủy và trao đổi liên quan."
      ...
      >
        {isLoading ? (
          ...
          <div className="p-5">
            <EmptyState title="Chưa có booking nào" description="Các chuyến xe bạn đặt sẽ xuất hiện tại đây." />
          </div>
        ) : (
