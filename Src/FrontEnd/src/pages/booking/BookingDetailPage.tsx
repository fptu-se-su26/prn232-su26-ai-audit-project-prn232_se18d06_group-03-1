    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
      ...
      <Card className="space-y-4 rounded-md p-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start justify-between gap-4 rounded-md bg-amber-50 px-3 py-2 text-sm dark:bg-amber-950/30">
            <span className="text-amber-800 dark:text-amber-300">Còn lại trả cho chủ xe khi nhận xe</span>
            <span className="shrink-0 font-semibold text-amber-900 dark:text-amber-200">{formatCurrency(Math.max(booking.totalAmount - booking.depositAmount, 0))}</span>
          </div>
