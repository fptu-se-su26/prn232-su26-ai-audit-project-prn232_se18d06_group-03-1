...
export default function StaffUserListPage({ title, subtitle, roleFilter, showRoleColumn = false }: StaffUserListPageProps) {
  ...
  async function handleConfirmAction() {
    ...
    try {
      ...
      await updateStaffUserStatus(confirmModal.user.userId, { status: newStatus });
