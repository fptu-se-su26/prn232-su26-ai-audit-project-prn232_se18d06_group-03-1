...
export default function Sidebar({ collapsed, onToggle }: { collapsed: boolean; onToggle: () => void }) {
  ...
  if (primaryRole === "Admin") {
    ...
    mainItems.push({ to: "/admin/booking-risk", label: "Rủi ro booking", icon: BrainCircuit });
  ...
  if (primaryRole === "Staff") {
    mainItems.push({ to: "/staff/booking-risk", label: "Rủi ro booking", icon: BrainCircuit });
  ...
  if (primaryRole === "Owner") {
    mainItems.push({ to: "/owner/booking-risk", label: "Rủi ro đơn thuê", icon: BrainCircuit });
  }
