...
import BookingRiskPage from "@/pages/staff/BookingRiskPage";
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route element={<RoleRoute roles={["Owner"]} />}>
            ...
            <Route path="/owner/booking-risk" element={<BookingRiskPage />} />
          ...
          <Route element={<RoleRoute roles={["Staff"]} />}>
            ...
            <Route path="/staff/booking-risk" element={<BookingRiskPage />} />
          ...
          <Route element={<RoleRoute roles={["Admin"]} />}>
            ...
            <Route path="/admin/booking-risk" element={<BookingRiskPage />} />
